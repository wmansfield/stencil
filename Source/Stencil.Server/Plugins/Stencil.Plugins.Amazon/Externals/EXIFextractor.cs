...
namespace Stencil.Plugins.Amazon.Externals
{
    public class EXIFextractor : IEnumerable
	{
		...
		{ 
			...
			Stream emptyBitmapStream = assembly.GetManifestResourceStream("Amazon.Plugins.Amazon.Externals.decoy.jpg");
		...
		/// <param name="sp"></param>
		public EXIFextractor(ref System.Drawing.Image bmp, string sp )
		{
