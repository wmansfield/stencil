...
namespace Stencil.Native.iOS.Core.UI
{
    ...
    /// </summary>
    public class SlideoutController : UIViewController
    {
        ...
        {
            if (BaseUIViewController.AllowRotate)
            {
        ...
        public NSObject StaticDataSource
        {
            get;
            set;
        }
        ...
        /// <summary>
        /// Bad Name, showing means "operation" not state
        /// </summary>
        ...
        private bool _leftMenuShown;
        private string _menuTextLeft = " < ";
        private string _menuTextRight = " > ";
        ...
        public bool RightMenuOpen
        {
            get
            {
                return _rightMenuShown;
            }
        }
        public Func<UIViewController, UINavigationController> NavigationControllerCreator { get; set;}
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="SlideoutController"/> is visible.
        /// </summary>
        /// <value>
        ...
        protected virtual void BeforeShowMenuRight()
        {
        }
        protected virtual void BeforeShowMenuLeft()
        {
        }
        ...
        /// View.
        /// </param>
        public virtual void SelectView (UIViewController view)
        {
            ...
            _internalTopNavigation = NavigationControllerCreator(view);
            _internalTopNavigation.View.Frame = new CGRect(0, 0,
            ...
            _externalContentView = view; // before menu so we can allow inheritor to check
        ...
        private UIPanGestureRecognizer _virtualTopBarPanRecognizer;
        private UIView _virtualTopBar;
        ...
        private void PanVirtualTopBar(UIView view)
        {
            if (_virtualTopBarPanRecognizer.State == UIGestureRecognizerState.Began) {
                _panOriginX = view.Frame.X;
                _ignorePan = false;

                if (!Visible)
                {
                    if (_virtualTopBarPanRecognizer.NumberOfTouches == 0)
                    {
                        _ignorePan = true;
                    }
                    else
                    {
                        CGPoint touch = _virtualTopBarPanRecognizer.LocationOfTouch(0, view);
                        if (touch.Y > SlideHeight) //  || _internalTopNavigation.NavigationBarHidden
                        {
                            _ignorePan = true;
                        }
            ...
            } else if (!_ignorePan && (_virtualTopBarPanRecognizer.State == UIGestureRecognizerState.Changed)) {
                nfloat t = _virtualTopBarPanRecognizer.TranslationInView (view).X;
                ...
                (_virtualTopBarPanRecognizer.State == UIGestureRecognizerState.Ended ||
                    _virtualTopBarPanRecognizer.State == UIGestureRecognizerState.Cancelled)) {
                nfloat velocity = _virtualTopBarPanRecognizer.VelocityInView (view).X;
        ...
        private class ProxyNavigationController : UINavigationController
        {
            ...
            /// </value>
            public SlideoutController ParentController { get; set; }
        ...
        {
            private readonly SlideoutController _controller;

            public SlideoutPanDelegate (SlideoutController controller)
            {
            ...
            {
                if (SlideoutController.DisableTouch)
                {
                    return false;
                }
